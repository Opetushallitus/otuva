...
java -Dspring.profiles.active=dev -Durl-ui="http://localhost:8080" -jar target/kayttooikeus-service-1.0.0-SNAPSHOT.jar --spring.config.location=${HOME}/oph-configuration/kayttooikeus.yml
