...
java -Dspring.profiles.active=dev -Dfront.kayttooikeus-service.baseUrl=/kayttooikeus-service/virkailija/ -jar target/kayttooikeus-service-1.0.0-SNAPSHOT.jar --spring.config.location=${HOME}/oph-configuration/kayttooikeus.yml
