...
public class KayttooikeusAnomusServiceTest {
    ...
    private static GrantKayttooikeusryhmaDto createGrantKayttooikeusryhmaDto(Long id, LocalDate loppupvm) {
    ...
    private static OrganisaatioViite createOrganisaatioViite() {
