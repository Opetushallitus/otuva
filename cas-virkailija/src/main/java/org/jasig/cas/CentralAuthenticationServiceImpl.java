...
public class CentralAuthenticationServiceImpl extends AbstractCentralAuthenticationService {
    ...
    public TicketGrantingTicket createTicketGrantingTicket(final AuthenticationContext context)
        ...
        checkStrongIdentificationHook(authentication.getCredentials());
    ...
    protected void checkStrongIdentificationHook(final Collection<? extends CredentialMetaData> credentials) throws AuthenticationException {
