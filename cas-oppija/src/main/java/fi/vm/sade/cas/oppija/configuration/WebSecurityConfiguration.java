...
public class WebSecurityConfiguration {
    ...
    public CasWebSecurityConfigurerAdapter casWebSecurityConfigurerAdapter() {
        return new CustomCasWebSecurityConfigurerAdapter(casProperties, securityProperties);
    }
    ...
    public class CustomCasWebSecurityConfigurerAdapter extends CasWebSecurityConfigurerAdapter {
        ...
        public CustomCasWebSecurityConfigurerAdapter(CasConfigurationProperties casProperties, SecurityProperties securityProperties) {
