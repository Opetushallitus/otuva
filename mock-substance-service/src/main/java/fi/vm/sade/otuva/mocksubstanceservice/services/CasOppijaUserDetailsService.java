package fi.vm.sade.otuva.mocksubstanceservice.services;
...
public class CasOppijaUserDetailsService implements AuthenticationUserDetailsService<CasAssertionAuthenticationToken> {
